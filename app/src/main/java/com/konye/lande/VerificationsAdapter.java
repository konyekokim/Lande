...
public class VerificationsAdapter extends ArrayAdapter<AppVerClass> {
    ArrayList<AppVerClass> appVerClasses;
    public VerificationsAdapter(Context context, int resources, ArrayList<AppVerClass> appVerClasses){
    ...
    public View getView(int position, View convertView, ViewGroup container){
        if(convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.verification_list_view_style,null);
        }
